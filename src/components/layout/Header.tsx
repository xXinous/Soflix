  ...
  return (
    <header className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-b from-black/80 to-transparent relative z-50">
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        <button className="w-5 h-5 sm:w-6 sm:h-6 hover:text-gray-300 cursor-pointer" type="button" aria-label="Buscar">
          <Search className="w-full h-full" />
        </button>
        <button className="w-5 h-5 sm:w-6 sm:h-6 hover:text-gray-300 cursor-pointer" type="button" aria-label="Notificações">
